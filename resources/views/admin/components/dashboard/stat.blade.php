<div class="row">
  ...
  <div class="col">
      <div class="card">
          <div class="card-block p-0 clearfix">
              <i class="icon-emotsmile bg-danger p-4 font-2xl mr-3 float-left"></i>
              <div class="h5 text-danger mb-0 pt-3">2</div>
  ...
  <div class="col">
      <div class="card">
          <div class="card-block p-0 clearfix">
              <i class="icon-like bg-success p-4 font-2xl mr-3 float-left"></i>
              <div class="h5 text-success mb-0 pt-3">24</div>
