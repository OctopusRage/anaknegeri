    ...
    <div class="card-block">
        ...
        <div class="form-group">
            ...
            <div>
                <div class="radio">
                    <label for="radio1">
                        <input type="radio" id="radio1" name="radios" value="option1" checked=""> Finansial
                    </label>
                </div>
                <div class="radio">
                    <label for="radio2">
                        <input type="radio" id="radio2" name="radios" value="option2"> Nonfinansial
                    </label>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12 col-sm-12">
                <div class="card">
                  <div class="card-block p-0 clearfix">
                      ...
                      <div class="h5 text-info mb-0 pt-3">Rp 12.,000,000</div>
