                ...
                <form action="{{route('campaign.update', $campaign->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            ...
                            <select name="category_id" class="form-control">
                                ...
                                @foreach ($category as $cat)
                                    <option {{$campaign->category_id == $cat->id ? "selected" : ""}} value="{{$cat->id}}">{{ $cat->category }}</option>
                                @endforeach
                            </select>
                        </div>
                        @if ($errors->has('email'))
                    ...
                    <div class="form-group  mb-3">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('title', $campaign->title, [
                                'class'                         => 'form-control',
                    ...
                    <div class="form-group  mb-3">
                        ...
                        {!! Form::textarea('subtitle', $campaign->subtitle, [
                            'class'                         => 'form-control',
                    ...
                    <div class="form-group  mb-3">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('deadline', $campaign->deadline, [
                                'class'                         => 'form-control',
                    ...
                    <div class="form-group  mb-3">
                        ...
                        {!! Form::textarea('address', $campaign->address, [
                            'class'                         => 'form-control',
                    ...
                    <div class="form-group  mb-3">
                        ...
                        <div class="checkbox">
                            <label for="check_finansial">
                                <input {{ !empty($financeSupport) ? "checked": "" }} type="checkbox" name="check_finansial" value="finansial" id="check_finansial">
                                Finansial
                            </label>
                        </div>
                        <div class="checkbox">
                            <label for="check_nonfinansial">
                                <input {{ count($nonfinanceSupport) > 0  ? "checked": "" }} type="checkbox" name="check_nonfinansial" value="non finansial" id="check_nonfinansial">
                                Non Finansial
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3" id="group-input-donasi-finansial">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::number('donasi_finansial', !empty($financeSupport) ? $financeSupport->pivot->amount : "", [
                                'class'                         => 'form-control',
                    ...
                    <div class="form-group  mb-3" id="group-input-donasi-non-finansial">
                        ...
                        <table class="table table-bordered" id="tableNonFinansial">
                            ...
                            <tbody>
                            @foreach($nonfinanceSupport as $supp)
                            <tr>
                                <td>
                                    <input type="text" name="item[]" value="{{$supp->pivot->item}}" class="form-control">
                                </td>
                                <td>
                                    <input type="number" name="amount[]" value="{{$supp->pivot->amount}}" class="form-control">
                                </td>
                                <td>
                        ...
                        <br>
                        <span class="help-block">{{$errors->first('item')}}<br/>{{$errors->first('amount')}}</span>
                    </div>

                    <div class="form-group  mb-3">
                        <label for="inputDetail">Detail Campaign</label>
                        {!! Form::textarea('detail', $campaign->detail, [
                            'class'                         => 'form-control',
...
@section('viewjs')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            @if(count($nonfinanceSupport) > 0  )
                $('#group-input-donasi-non-finansial').show();
            @endif
            @if(!empty($financeSupport))
