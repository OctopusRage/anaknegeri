<ul class="nav nav-tabs nav-justified text-bold" role="tablist" style="margin-top: -38px; background-color: rgba(255,255,255,.3);">
    <li class="nav-item">
        <a class="nav-link active" data-toggle="tab" href="#home4" role="tab" aria-controls="home"><i class="icon-info"></i> Detail </a>
    </li>
    <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#profile4" role="tab" aria-controls="profile"><i class="icon-note"></i> Campaign &nbsp;<span class="badge badge-pill badge-success">29</span></a>
    </li>
    <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#messages4" role="tab" aria-controls="messages"><i class="icon-bubbles"></i> Kontribusi &nbsp;<span class="badge badge-pill badge-info">29</span></a>
    </li>
</ul>
